    ...
    <section>
        ...
        <div className="placeOrder-items">   
            ...
            <h4>Address: </h4>
                ...
                <br></br>{cart.shippingAddress.city}{' '}
            ...
            {cart.cartItems.length === 0 ? (
                ...
                {cart.cartItems.map((item, index) => (
                    ...
                    <Link className='placeOrder-item-title' to={`/product/${item.product}`}>{item.name}</Link>
                        ${(item.price * 100) / 100}
                    </div>                  
                    </li>
                ))}
        ...
        <div className="placeOrder-summary">
            <h3>Order Summary</h3>
                <div className='placeOrder-summary-item'><h5>Items: </h5>${cart.itemsPrice}</div> 
                <div className='placeOrder-summary-item'><h5>Shipping: </h5>${cart.shippingPrice}</div>  
                <div className='placeOrder-summary-item'><h5>Tax: </h5>${cart.taxPrice}</div> 
                <hr></hr> 
                <div className='placeOrder-summary-item order-summary-total'><h5>Total: </h5>${cart.totalPrice}</div>  
                {error && (
